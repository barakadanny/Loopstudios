                ...
                <div class="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
                    <div class="">
                        ...
                        <ul class="flex flex-wrap items-center justify-center gap-x-4 gap-y-3 xl:justify-end">
                            ...
                            <li>
                                <a href="#" title="" class="text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Careers </a>
                            </li>

                            <li>
                                <a href="#" title="" class="text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Events </a>
                            </li>

                            <li>
                                <a href="#" title="" class="text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Products </a>
                            </li>
                    ...
                    <div class="items-center mt-8 xl:mt-0  xl:space-x-8">
                        <ul class="flex items-center justify-center space-x-2 lg:mb-3 xl:justify-end">
                            <li>
